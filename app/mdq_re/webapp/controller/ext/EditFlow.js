sap.ui.define([
     ...
     *
     * @name udina.sample.mdq_re.controller.ext.EditFlow
     * @hideconstructor
     * @public
     * @since 1.2.0
     */
    return ControllerExtension.extend("udina.sample.mdq_re.controller.ext.EditFlow", {
        ...
        onSave: function (oEvent) {
            this.saveDocument(this.getView().getBindingContext(), oEvent.getSource());
        },

        onSavePreProcessed: function (oEvent) {
            this.saveDocumentPreProcessed(this.getView().getBindingContext(), oEvent.getSource());
        },
